...
std::string mstd::subString(std::string str, int start, int end)
{
    std::string val;
...
int mstd::indexOf(const char *str, char token)
{
...
std::vector<std::string> mstd::strip(const char *str, char Token)
{
